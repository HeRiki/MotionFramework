...
namespace MotionFramework.Resource
{
	public class AssetReference
	{
		...
		{
			if(AssetSystem.AssetSystemMode == EAssetSystemMode.Resources)
				throw new System.Exception($"{nameof(EAssetSystemMode.Resources)} is not support to assign asset name.");
